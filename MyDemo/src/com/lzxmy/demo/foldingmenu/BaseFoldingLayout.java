...
package com.lzxmy.demo.foldingmenu;
...
//        }
		...
		float depth = mIsHorizontal ? (float) Math
				.sqrt(mFoldDrawWidth * mFoldDrawWidth - translatedDistanceFoldSquared)
				: (float) Math
						.sqrt(mFoldDrawHeight * mFoldDrawHeight - translatedDistanceFoldSquared);
