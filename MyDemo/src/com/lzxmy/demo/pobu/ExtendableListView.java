 ...
 * - Focus
 * <p/>
 * Note: we only really extend {@link AbsListView} so we can appear to be one of its direct subclasses.
 * However most of the code we need to modify is either 1. hidden or 2. package private
 * So a lot of it's code and some {@link AdapterView} code is repeated here
...
//            case TOUCH_MODE_OVERSCROLL:
    ...
    /**
     * Re-implementing some properties in {@link ViewGroup.LayoutParams} since they're package
