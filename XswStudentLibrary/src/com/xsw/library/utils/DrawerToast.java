...
//        mTopView.setGravity(Gravity.TOP);
        ...
        mTopView2.setGravity(Gravity.CENTER);
//
...
//        LayoutParams    layoutParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        ...
        mView.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.TOP);

//
           vi = LayoutInflater.from(mContext).inflate(com.xsw.library.R.layout.toast_dialog,
                null);
...
//    }
    ...
    public void show(String msg, Long duration, Animation startAnim, Animation endAnim) {
        show( duration, startAnim, endAnim);
    }
     ...
     * @param endAnim   离场动画
     */
    public final void show(Long duration, Animation startAnim, final Animation endAnim) {
        //反射过程异常时则使用源生Toast
...
//    }
    ...
    private void initTN() {
        ...
        mToast.setGravity(Gravity.TOP, 10, 10);
        Class<Toast> clazz = Toast.class;
        try {
            mTN = clazz.getDeclaredField("mTN");
            mTN.setAccessible(true);
            mObj = mTN.get(mToast);
            showMethod = mObj.getClass().getDeclaredMethod("show", mObj.getClass());
            hideMethod = mObj.getClass().getDeclaredMethod("hide", mObj.getClass());
