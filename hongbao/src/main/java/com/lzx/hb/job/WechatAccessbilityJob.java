...
//            ischeck = true;
            //点中了红包，下一步就是去拆红包
//            Toast.makeText(getContext(), "点中了红包，下一步就是去拆红包", Toast.LENGTH_LONG).show();
            handleLuckyMoneyReceive();
        } else if ("com.tencent.mm.plugin.luckymoney.ui.LuckyMoneyDetailUI".equals(event.getClassName())) {
            //拆完红包后看详细的纪录界面
//            Toast.makeText(getContext(), "拆完红包后看详细的记录界面", Toast.LENGTH_LONG).show();
            //nonething
            home();
...
//            Toast.makeText(getContext(), "1ddd", Toast.LENGTH_LONG).show();
            home();
        }
...
//                    Toast.makeText(getContext(), "当前界面找不到红包", Toast.LENGTH_LONG).show();
            List<AccessibilityNodeInfo> listd = nodeInfo.findAccessibilityNodeInfosByText("拆红包");
            if (listd != null && !listd.isEmpty()) {
                listd.get(listd.size() - 1).getParent().performAction(AccessibilityNodeInfo.ACTION_CLICK);
                home(10000);
                return;
            } else {
                home();
...
// else {
////            Toast.makeText(getContext(), "1eee", Toast.LENGTH_LONG).show();
//                        home();
////                    }
////                    break;
////                }
...
//            Toast.makeText(getContext(), "无点击 拆红包", Toast.LENGTH_LONG).show();
            home();
        }
    }
