...
//	    AspLog.e(TAG, "callStaticMethod2 "+className +":"+methodname+" reason=" +  e+" "+ e.getMessage());
	}
	return null;
    }
...
//	    AspLog.w(TAG, "callDeclaredMethod", e);
	} catch (InvocationTargetException e) {
//	    AspLog.w(TAG, "callDeclaredMethod", e);
	}catch(Exception e){
//	    AspLog.w(TAG, "callDeclaredMethod--" + method, e);
	}
	return null;
    }
...
//	    AspLog.w(TAG, "getMethod--" + method, e);
...
//	    AspLog.e(TAG, "getFieldValue " +fieldname +",reason="+ ex+" "+ ex.getMessage());
	} catch (Exception ex) {
//	    AspLog.e(TAG, "getFieldValue "+ fieldname +",reason=" + ex+" "+ ex.getMessage());
	}
	return retValue;
...
//	    AspLog.e(TAG, "getDeclaredFieldValue " +fieldname +",reason="+ ex+" "+ ex.getMessage());
	} catch (Exception ex) {
//	    AspLog.e(TAG, "getDeclaredFieldValue "+ fieldname +",reason="+ ex+" "+ ex.getMessage());
	}
	return retValue;
...
//	    AspLog.e(TAG, "getDeclaredFieldValue2 "+declaredclassname +":"+fieldname+",reason="+ ex+" "+ ex.getMessage());
	} catch (ClassNotFoundException e) {
//	    AspLog.e(TAG, "getDeclaredFieldValue2 "+declaredclassname +":"+fieldname+",reason="+ e+" "+ e.getMessage());
	} catch (Exception ex) {
//	    AspLog.e(TAG, "getDeclaredFieldValue2 "+declaredclassname +":"+fieldname+",reason="+ ex+" "+ ex.getMessage());
	}
	return retValue;
...
//	    AspLog.e(TAG, "getStaticFieldValue "+fieldname+",reason="+ ex+" "+ ex.getMessage());
	} catch (Exception ex) {
//	    AspLog.e(TAG, "getStaticFieldValue "+fieldname+",reason="+ ex+" "+ ex.getMessage());
	}
	return retValue;
...
//	    AspLog.e(TAG, "getStaticFieldValue2 "+className +":"+fieldname+",reason="+ e+" "+ e.getMessage());
	}
	return null;
    }
...
//	    AspLog.w(TAG, "getField", e);
	}catch(Exception e){
//	    AspLog.w(TAG, "getField--" + name, e);
	}
	return null;
    }
...
//	    AspLog.w(TAG, "getDeclaredField", e);
	}catch(Exception e){
//	    AspLog.w(TAG, "getDeclaredField--" + name, e);
	}
	return null;
    }
...
//	    AspLog.e(TAG, "setFieldValue "+ fieldname+",reason="+ex+" "+ ex.getMessage());
	} catch (Exception ex) {
//	    AspLog.e(TAG, "setFieldValue "+ fieldname+",reason="+ ex+" "+ ex.getMessage());
	}
    }
...
//	    AspLog.e(TAG, "setDeclaredFieldValue "+fieldname+",reason="+ ex+" "+ ex.getMessage());
	} catch (Exception ex) {
//	    AspLog.e(TAG, "setDeclaredFieldValue "+fieldname+",reason="+ ex+" "+ ex.getMessage());
	}
    }
...
//	    AspLog.e(TAG, "setDeclaredFieldValue2 "+declaredclassname +":"+fieldname+",reason="+ e+" "+ e.getMessage());
	} catch (NoSuchFieldException ex) {
//	    AspLog.e(TAG, "setDeclaredFieldValue2 "+declaredclassname +":"+fieldname+",reason="+ ex+" "+ ex.getMessage());
	} catch (Exception ex) {
//	    AspLog.e(TAG, "setDeclaredFieldValue2 "+declaredclassname +":"+fieldname+",reason="+ ex+" "+ ex.getMessage());
	}
    }
...
//	    AspLog.e(TAG, "setStaticFieldValue "+fieldname+",reason="+ ex+" "+ ex.getMessage());
	} catch (Exception ex) {
//	    AspLog.e(TAG, "setStaticFieldValue "+fieldname+",reason="+ ex+" "+ ex.getMessage());
	}
    }
...
//	    AspLog.e(TAG, "setStaticFieldValue "+className +":"+ fieldname+",reason="+ ex+" "+ ex.getMessage());
	}
    }
...
//	    AspLog.e(TAG, "newInstance fail, reason="+ ex+",cause="+ ex.getCause()+",clazz="+classz);
	} catch (Exception ex) {
//	    AspLog.e(TAG, "newInstance fail, reason="+ ex+",cause="+ ex.getCause()+",clazz="+classz);
	}
	return retObj;
...
//	    AspLog.e(TAG, "newInstance1, reason="+ e+",cause="+ e.getCause()+",clazz="+classz);
	} catch (InstantiationException e) {
//	    AspLog.e(TAG, "newInstance2, reason="+ e+",cause="+ e.getCause()+",clazz="+classz);
	} catch (Exception e) {
//	    AspLog.e(TAG, "newInstance2, reason="+ e+",cause="+ e.getCause()+",clazz="+classz);
	}
	return null;
...
//	    AspLog.e(TAG, "newInstance3 "+ e+",cause="+e.getCause() +",clazz="+className +",length="+length);
	    return null;
	}
    }
...
//	    AspLog.e(TAG, "newInstance4 "+ e+",cause="+ e.getClass());
	}
	return null;
    }
    /**
...
//	    AspLog.e(TAG, "newInstance5 "+ e+",cause="+ e.getClass());
	}
	return null;
    }
...
//	    AspLog.e(TAG, "classDerivedFrom "+className +","+strbaseclazz+",reason="+ e+" "+ e.getMessage());
	}
	return false;
    }
}
