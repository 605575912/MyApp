...
//	}
//
//	public HourView(Context context, AttributeSet attrs, int defStyle) {
...
//		canvas.drawLine(0, rectheight * line, getWidth(),
//				rectheight * line + 1, paint_gray);
//		if (floats == null) {
...
//		sCanvas.drawText(list.get(e), getPaddingLeft(), y0 + baseline,
//				paint_black);
//		sCanvas.drawText(hour, getPaddingLeft() * 2, rectheight / 2
